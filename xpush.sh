...
# Inform the user about pushing manually
echo -e "\033[1;33mChanges have been committed locally. To push changes to the remote repository, use:\033[0m"
echo -e "\033[1;36m  git push origin $branch\033[0m"
